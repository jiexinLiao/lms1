      ...
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
          ...
          <div className='hidden md:flex flex-col items-start w-full'>
            ...
            <div className='flex items-center gap-2 pt-4'>
              ...
              <button className='bg-blue-600 w-24 h-9 text-white rounded hover:bg-blue-700 transition-colors duration-300 cursor-pointer'>Subscribe</button>
            </div>
          </div>
      </div>
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 @ jiexin. All right Reserved</p>
    </footer>
  )
}
