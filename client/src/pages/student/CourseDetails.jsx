    ...
          <div className='absolute top-0 left-0 w-full h-section-height z-1 bg-gradient-to-b from-cyan-100/70'></div>
      ...
      {/*review and rating */}
               <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                ...
                <p className='text-blue-600'>({courseData.courseRating.length}
      ...
      <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]:'>
        ...
        <div className='p-5'>
                    ...
                    <button onClick={enrollCourse} className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium  hover:bg-blue-700 transition-colors duration-300 cursor-pointer'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll now'}</button>
